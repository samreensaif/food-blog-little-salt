  ...
  return (
    <section className="mb-10">
        ...
        {res.map((item: Articles, index: number) => (
          ...
          >
            ...
            <div className="flex flex-col space-y-3 text-left px-4 py-3">
              ...
              >
                <button className="inline-flex group text-white py-2 px-4 mt-2 bg-[#7C4EE4] rounded-md hover:underline">
      ...
      <div className="text-center px-4 hover:scale-105 transition-all duration-300 hover:underline">
        <Link href="/blog">
          <p className="inline-flex group text-center rounded-full text-white py-3 px-6 bg-[#7C4EE4] hover:underline">
            View More <MoveRight className="opacity-0 transform translate-x-[-10px] group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-1000 ml-2" />
          </p>
        </Link>
      </div>
    </section>
